...
const SecondSection = () => {
    return (
        <div className='min-w-full md:h-[75vw] 2xl:h-[120vh] flex flex-col justify-center items-center overflow-hidden bg-gradient-to-r from-[#FFD8AE00] via-[#FFD8AE] to-[#FFD8AE00] pt-20 md:pt-32 relative'>
            ...
            <div className='relative  w-[100%] md:w-[105vw] h-[105vw] md:h-[95vw] flex flex-col justify-start rounded-t-[50%] bg-gradient-to-b from-[#F4A15D] via-[#FFD8AE] to-[#fff] border-dashed border-t-2 border-[#D5760E] md:mt-32'>
                ...
                <div className="text-center pt-16 md:pt-64 px-4">
                    ...
                    <h2 className='text-5xl md:text-8xl font-bold text-[#2E0A49] pt-4 md:pt-8'>Buy Gold in Seconds</h2>
                    <h5 className={`${montserrat.className} text-2xl md:text-4xl text-[#2E0A49] font-medium md:px-80 pt-4 md:pt-10`}>

...
const AppPreviewSection = () => {
    return (
        <div className='mt-64 flex flex-col justify-center items-center w-full px-4 text-center'>
            <h3 className={`text-[#2E0A49] ${gilroy.className} text-4xl md:text-6xl font-[400]`}>Designed to Feel Premium</h3>
            <h2 className='text-6xl md:text-8xl font-bold text-[#2E0A49] pt-4 md:pt-6'>Because finance should feel fine.</h2>
            ...
            <div className="relative flex justify-center items-center w-full md:max-w-6xl mx-auto mt-8 md:mt-12 h-[500px] md:h-[700px]">
                {/* Left Image */}

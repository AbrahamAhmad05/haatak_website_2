...
function OurWinsSection() {
    return (
        <div className='text-[#2E0A49] w-full py-16 space-y-16'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr_1fr] ">
                ...
                <div className="bg-gradient-to-br from-[#F3C862] via-[#FFE196] via-80% to-[#D99A26] p-1 rounded-l-lg">
                    <div className="w-auto h-52 rounded-l-lg p-6 transition-colors duration-300 bg-gradient-br from-[#E7CB86] via-[#FFF4DF] to-[#E7CB86] md:px-20 lg:px-32 flex justify-center items-center" >

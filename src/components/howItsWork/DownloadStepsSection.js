...
function DownloadStepsSection() {
  return (
    <div className='mt-40 text-center text-[#2E0A49]'>
      ...
      <div className="flex flex-col items-center justify-center gap-44 my-44 md:gap-64 md:my-64 px-4 sm:px-6 lg:px-8">
        {data.map((e, i) => (
